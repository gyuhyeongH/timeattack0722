...
class JobPostActivity(models.Model):
    ...
    applystate = models.ForeignKey('ApplyState', on_delete=models.CASCADE, null=True)
    recruitmentstate = models.ForeignKey('RecruitmentState', on_delete=models.CASCADE, null=True)
...
class RecruitmentState(models.Model):
    recruitstate = models.CharField(max_length=128)

    class Meta:
        db_table = 'recruitstate'